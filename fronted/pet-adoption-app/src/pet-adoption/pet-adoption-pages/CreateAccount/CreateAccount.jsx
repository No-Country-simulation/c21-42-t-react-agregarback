  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center h-screen p-5 bg-[#F4F0EF]">
        <form className="p-4">
          <h1 className="text-2xl font-semibold text-[#484646]">Crear cuenta</h1>
          <input className="w-[22rem] h-14 my-7 pl-4 rounded-lg bg-[#F4F0EF] border border-[#484646] placeholder-[#484646]" placeholder="Correo electronico"></input>
        ...
        <div className="flex flex-col justify-center items-center mb-2">
          <button className="flex items-center justify-center w-[22rem] h-14 mb-2 font-semibold rounded-lg bg-[#F4F0EF] border border-[#484646]">
          ...
          <button className="w-[22rem] px-6 py-4 rounded-xl border-none">
            <span className="text-[#CB7A01] font-semibold underline">Iniciar sesión</span>
          </button>
        </div>
